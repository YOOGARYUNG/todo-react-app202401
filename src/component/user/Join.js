...
const Join = () => {
    ...
    const nameHandler = e => {
        ...
        let msg, flag; // 검증 메시지를 임시저정할 지역변수
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        ...
                        <span style={correct.userName
                            ? {color: 'green'}
                            : {color: 'red'}}>{message.userName}</span>
                    </Grid>
                    <Grid item xs={12}>
                        <TextField
                            variant="outlined"
                    ...
                    <Grid item xs={12}>
                        ...
                        <span style={correct.password
                            ? {color: 'green'}
                            : {color: 'red'}}>{message.password}</span>
                    </Grid>
                    ...
                    <Grid item xs={12}>
                        ...
                        />
                        <span id="check-text" style={correct.passwordCheck
                            ? {color: 'green'}
                            : {color: 'red'}}>{message.passwordCheck}</span>
                    </Grid>
